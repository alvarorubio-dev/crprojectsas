          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
            <div className="bg-white rounded-sm max-w-2xl w-full max-h-[80vh] flex flex-col border border-gray-200 shadow-2xl">
              <div className="p-6 border-b border-gray-100 flex items-center justify-between">
                <h2 className="font-heading text-xl text-gray-900 font-bold">
                  Política de Tratamiento de Datos Personales
                </h2>
                <button
                  type="button"
              ...
              <div className="p-6 overflow-y-auto text-sm text-gray-600 space-y-4 leading-relaxed">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 mb-1">Finalidad</h3>
                  <p>
                ...
                <div>
                  <h3 className="font-bold text-gray-900 mb-1">Autorización</h3>
                  <p>
