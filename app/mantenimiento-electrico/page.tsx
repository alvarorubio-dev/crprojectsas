...
export const metadata: Metadata = {
  title: "Mantenimiento Eléctrico para Maquinaria Pesada — Alternadores y Arranque",
  description: "Soluciones completas para sistemas eléctricos de maquinaria pesada. Reparación de alternadores, motores de arranque, revisión de cableado y diagnóstico eléctrico profesional.",
  alternates: { canonical: "https://www.crprojectsas.com/mantenimiento-electrico" },
};
...
export default function MantenimientoElectricoPage() {
  return (
    <ServicePageTemplate
      ...
      heroImage="https://images.pexels.com/photos/257736/pexels-photo-257736.jpeg?auto=compress&cs=tinysrgb&w=1920"
      features={[
      ...
      faqs={[
        { question: "¿Reparan alternadores y arranques en campo?", answer: "Sí, en muchos casos podemos diagnosticar y reparar en campo. Para reconstrucciones completas de alternadores o arranques, se recomienda llevar el componente al taller." },
        { question: "¿Trabajan con todas las marcas de maquinaria?", answer: "Sí. Atendemos maquinaria CAT, John Deere, New Holland, CNH, Case, Komatsu y otras marcas de maquinaria amarilla y vehículos pesados." },
        { question: "¿Pueden detectar cortos circuitos intermitentes?", answer: "Sí. Contamos con equipos de diagnóstico eléctrico profesional que permiten identificar fallas intermitentes y cortos difíciles de localizar con métodos convencionales." },
        { question: "¿Cuánto tarda un diagnóstico eléctrico?", answer: "Un diagnóstico eléctrico básico toma entre 1-2 horas. Si la falla es compleja o intermitente, puede requerir más tiempo para una evaluación completa." },
      ]}
