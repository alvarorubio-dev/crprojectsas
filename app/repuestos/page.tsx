...
export default function RepuestosPage() {
  return (
    <ServicePageTemplate
      ...
      faqs={[
        {
          question: "¿Manejan partes genuinas u aftermarket?",
          answer:
            "Ambas. Ofrecemos partes genuinas OEM de fábrica y alternativas aftermarket de alta calidad. Le asesoramos para que elija la mejor opción según su presupuesto y necesidad: genuino para máxima durabilidad o aftermarket para mejor relación precio-rendimiento.",
        },
        {
          question: "¿Tienen disponibilidad inmediata?",
          answer:
            "Sí en muchas referencias críticas. Por ejemplo, tenemos el CAT COM ADAPTER 3 (ref. 478-0235) con disponibilidad inmediata. Para otras referencias, consulte por WhatsApp y le confirmamos stock o tiempo de importación.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Manejamos repuestos para CAT, CNH, John Deere, New Holland, Case, y más. Turbos Garrett y BorgWarner, herramientas Nexiq y accesorios de diagnóstico CAT.",
        },
      ]}
